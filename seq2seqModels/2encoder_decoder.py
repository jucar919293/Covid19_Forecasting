...
class Seq2SeqModel(nn.Module):
    def __init__(self, size_seq, n_signals, primer_dataset, rnn_dim):
        super(Seq2SeqModel, self).__init__()
        self.size_seq = size_seq
        self.n_signals = n_signals
        self.primer_dataset = primer_dataset
        # Creating encoder:
    ...
    def _train(self, lr, epochs, seqs, mask_seq, ys, ysT, mask_ys, allys, wk_ahead):
        n = seqs.shape[0]
        mini_batch_size = n // 2
